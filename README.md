...
**GenAI / LLMs**  
RAG · Agentic AI · Multi-Agent Systems · LLM-as-a-Judge · Prompt Engineering · AI Evaluation · Context Engineering · LangChain · LangGraph · LangSmith · OpenAI GPT Models · Hugging Face · Azure AI Search · Vector Search · Embeddings

**Programming / Data**  
Python · PySpark · SQL · Pandas · NumPy · Scikit-learn · PyTorch · TensorFlow · FastAPI · Pydantic · REST APIs · Airflow · PyMongo · pytest

**Cloud / Infrastructure**  
AWS S3 · EC2 · Lambda · Glue · EMR · Kinesis · Azure AI Foundry · Azure Blob Storage · Azure Monitor · Redis · MongoDB · PostgreSQL · SQL Server · Kubernetes · Docker · ECS · ECR · CloudWatch

**Monitoring / Tools**  
Splunk · Datadog · Git · Bitbucket · GitLab · JIRA · Postman · Tableau · Power BI
